...
<p class="mt-1">Contact: <!--email_off--><a href="mailto:info&#64;threadspec&#46;org" class="text-emerald-700 hover:underline">info&#64;threadspec&#46;org</a><!--/email_off--></p>
...
#
# Two default calls, in order. The first is region-scoped to the EEA, the UK
# and Switzerland and denies everything pending a CMP signal; the second
